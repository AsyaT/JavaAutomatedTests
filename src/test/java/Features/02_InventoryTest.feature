...
Feature: User at Inventory operation
  ...
  Scenario: Do scan correct barcodes
    ...
    And weight is '25.3'
    And quantity is '1'
    When I scan 'GS1_DATABAR_EXP' barcode '0104630037036817310302530010082011190820171908252100002923000'
    Then I see string in table with number '1'
    And weight is '50.6'
    And quantity is '2'
    When I scan 'GS1_DATABAR_EXP' barcode '0104630037036817310302470010082011190820171908252100003923000'
    Then I see string in table with number '1'
    And weight is '75.3'
    And quantity is '3'
    When I scan 'GS1_DATABAR_EXP' barcode '0104630037036817310302470010082011200120172001262100004923000'
    Then I see string in table with number '1'
    And weight is '100.0'
    And quantity is '4'
    When I scan 'GS1_DATABAR_EXP' barcode '0104630037036817310302470010082011200120172001262100005925000'
    Then I see string in table with number '1'
    And weight is '124.7'
    And quantity is '5'
    When I scan 'GS1_DATABAR_EXP' barcode '0104660017708243310300745610082011190820171908252100046922000'
  ...
  Scenario: Do scan error GS1 barcodes
    When I scan 'GS1_DATABAR_EXP' barcode '0104630037036817310302470010082011200120172001262100357929000'
    Then I see alert title 'Ошибка при сканировании штрих-кода!' and message 'Производитель с номером 9 не найден'
    When I scan 'GS1_DATABAR_EXP' barcode '010463004929467011190820171909091008202100632926000'
  ...
  Scenario: Scan again barcode with different nomenclatures
    When I scan 'GS1_DATABAR_EXP' barcode '0104607094817550310301219710082011200205172002102100002925000'
    Then I see string in table with number '3'
    And quantity is '2'

  Scenario: Scan different databars
    When I scan 'GS1_DATABAR_EXP' barcode '0104607094817093310300795610082011190820171908252100022922000'
    ...
    When I scan 'GS1_DATABAR_EXP' barcode '0104607094812999310300615610082011190820171908252100023922000'
    ...
    When I scan 'GS1_DATABAR_EXP' barcode '0104607094816553310300825610082011190820171908252100024922000'
 ...
 Scenario: Scan product barcode again
 	When I scan 'GS1_DATABAR_EXP' barcode '0104607094817093310300795610082011190820171908252100022922000'
 	Then I see alert title 'Ошибка при сканировании штрих-кода!' and message 'Штрих-код 0104607094817093310300795610082011190820171908252100022922000 уже был отсканирован'
  ...
  Scenario: use button bar-code
    ...
    When I scan 'GS1_DATABAR_EXP' barcode '0104630037036817310302530010082011190820171908252100035923000'
